...
The deepened module is tested with the stand-in running in the test suite.
...
The deep module owns the logic; the transport is injected as an **adapter**.
...
Third-party services (Stripe, Twilio, etc.) you don't control.
