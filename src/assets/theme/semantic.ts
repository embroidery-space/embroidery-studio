export const semantic = {
  ...
  success:  { 50: "#eaf0e5", 100: "#e2ebdb", 200: "#d5e2cb", 300: "#c6d6b7", 400: "#b6cba4", 500: "#a3be8c", 600: "#8dae70", 700: "#789c58", 800: "#64824a", 900: "#465b34", 950: "#354427" }, // prettier-ignore
    ...
    dark: {
      ...
      list: {
        option: {
          ...
          selectedColor: "{text.contrast.color}",
          selectedFocusColor: "{text.contrast.color}",
          icon: {
            color: "{text.color}",
